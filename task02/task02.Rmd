...
In this second task, I will conduct an additional analysis using the
"Technologies of Rebellion" dataset from @balcells2014does. The instructions
were as follows: "_You should use the 'Technologies of Rebellion' (TR) instead
of the 'Peace Research Institute of Oslo' (PRIO) dataset. You should control
for: Post 1990, rough terrain, population, GDP per capita, oil exporter, ethnic
fractionalization, democracy, military personnel, external support for
government, external support for rebels, region._"
